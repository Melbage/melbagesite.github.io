...
#/Users/paulcarter/Documents/melbageWebsite/Live/melbagesite.github.io/mgatour/season5/apr03/TestCase
...
for file in glob.glob(StartPath ): 
	if file.endswith( ".htm" ): 
		try:
			FileList.append( os.path.basename(file)) # Removes the path from the return set from glob.glob() function
